...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Redirect to onboarding if target role is missing, else to dashboard
  ...
  return (
    <div className="min-h-screen bg-background-dark text-slate-100 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/3 w-96 h-96 bg-brand-indigo/15 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="w-full max-w-md glass-panel p-8 md:p-10 z-10 border border-slate-800/90 shadow-2xl">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-xs text-slate-400 mt-1">Sign in to access your AI Career Intelligence</p>
        </div>
